      ...
      <main className="max-w-6xl mx-auto px-6 sm:px-8 py-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <section className="lg:col-span-7">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a href="#join" className="inline-flex items-center px-6 py-3 rounded-xl bg-gradient-to-r from-sky-500 to-violet-600 text-black font-semibold shadow-lg">Join the Waitlist</a>
            <a href="#demo" className="inline-flex items-center px-6 py-3 rounded-xl border border-slate-700 text-slate-200 hover:bg-slate-700">See Concept Video</a>
          </div>
      ...
      <section id="why" className="max-w-6xl mx-auto px-6 sm:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-4 text-slate-300 max-w-xl">QSV recreates the delight of discovery and the tactile feeling of shopping without the friction of travel. For brands, it’s a new channel to tell stories, create events, and sell — both physical and digital products.</p>
