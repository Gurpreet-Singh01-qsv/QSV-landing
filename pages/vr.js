      ...
      <group ref={productRef}>
        ...
        {type === 'sneaker' && (
          <group
            ...
            onClick={handleClick}
          >
            {/* Sneaker Sole - Realistic Shape */}
            <mesh position={[0, -0.15, 0]} rotation={[0, 0, 0]}>
              <boxGeometry args={[1.4, 0.15, 0.95]} />
              <meshStandardMaterial 
        ...
        {type === 'watch' && (
          ...
          >
            ...
            <mesh position={[0, 0.11, 0]}>
              <cylinderGeometry args={[0.52, 0.48, 0.05, 32]} />
              <meshStandardMaterial 
                color="#9b6cff"
                emissive="#9b6cff"
            ...
            {/* Watch Face - Holographic Display */}
            ...
            <mesh position={[0, 0.13, 0]}>
              <cylinderGeometry args={[0.3, 0.3, 0.005, 32]} />
              <meshBasicMaterial 
                color="#00ffff"
                transparent
            ...
            {/* Watch Buttons */}
            <mesh position={[0.48, 0.15, 0]} rotation={[0, 0, Math.PI / 2]}>
        ...
        {/* Realistic Neural Interface Headset */}
        {type === 'headset' && (
          <group
            onPointerOver={() => handleHover(true)}
            onPointerOut={() => handleHover(false)}
          ...
          >
            {/* Main Headset Visor */}
            <mesh position={[0, 0, 0.1]} rotation={[0.2, 0, 0]}>
            ...
            <mesh position={[0, 0, 0.18]} rotation={[0.2, 0, 0]}>
            ...
            {/* Head Strap - Top */}
            <mesh position={[0, 0.4, -0.2]} rotation={[0, 0, Math.PI / 2]}>
